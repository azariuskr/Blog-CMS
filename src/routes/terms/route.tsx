...
import { ArrowLeft, FileText, AlertTriangle, Scale, Gavel, Ban } from 'lucide-react'
    ...
    <main className="min-h-screen bg-background py-10 px-4 md:px-8 transition-colors duration-300">
      <div className="container max-w-4xl mx-auto space-y-8">
          ...
          <div className="p-6 md:p-8 space-y-10">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-destructive/10 p-4 rounded-lg border border-destructive/20 flex gap-3">
                ...
                <div>
                  <h4 className="font-bold text-destructive text-sm mb-1">Important Notice</h4>
            ...
            <section className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                {[
                  ...
                  <div
                    key={i}
                    className="p-3 rounded-md bg-muted/50 border border-border flex items-start gap-2"
                  >
        ...
        <div className="text-center text-sm text-muted-foreground pb-8">
          &copy; 2025 Better Auth Starter. All rights reserved.
        </div>
