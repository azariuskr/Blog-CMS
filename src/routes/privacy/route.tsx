    ...
    return (
        <main className="min-h-screen bg-background py-10 px-4 md:px-8 transition-colors duration-300">
            <div className="container max-w-4xl mx-auto space-y-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="grid gap-6 mt-4">
                                ...
                                <div>
                                    ...
                                    <ul className="grid md:grid-cols-2 gap-x-8 gap-y-4 text-muted-foreground text-sm">
                                        {[
                                            {
                                                term: 'Account',
                                            ...
                                            {
                                                term: 'Application',
                                                desc: 'refers to Better Auth Starter, the software program provided by the Company.',
                                            },
                                            {
                                                term: 'Company',
                                                desc: '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Better Auth Starter.',
                                            },
                                            {
                                                term: 'Cookies',
                                            ...
                                            {
                                                term: 'Website',
                                                desc: 'refers to Better Auth Starter, accessible from https://better-auth-starter.com',
                                            },
                                            {
                                                term: 'You',
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-muted/50 p-4 rounded-lg border border-border/50 space-y-2">
                                        <h4 className="font-bold text-foreground">Usage Data</h4>
                                        <p className="text-muted-foreground text-sm">
                                    ...
                                    <div className="bg-muted/50 p-4 rounded-lg border border-border/50 space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            ...
                                            such information and Personal Data, during registration or
                                    ...
                                    <div className="bg-muted/50 p-4 rounded-lg border border-border/50 space-y-3">
                                        <h4 className="font-bold text-foreground flex items-center gap-2">
                                            <Cookie className="h-4 w-4" /> Tracking Technologies and
                                            Cookies
                                        </h4>
                                        ...
                                        {[
                                            {
                                                ...
                                                body: 'including to monitor the usage of our Service.',
                                            },
                                            {
                                                title: 'To manage Your Account',
                                                body: 'to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.',
                                            },
                                            {
                                                title: 'For the performance of a contract',
                                                body: 'the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.',
                                            },
                                            {
                                                title: 'To contact You',
                                                body: "To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.",
                                            },
                                            {
                                                title: 'To provide You',
                                                body: 'with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.',
                                            },
                                            {
                                                title: 'To manage Your requests',
                                                body: 'To attend and manage Your requests to Us.',
                                            },
                                            {
                                                title: 'For business transfers',
                                                body: 'We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.',
                                            },
                                            {
                                                title: 'For other purposes',
                                                body: 'We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.',
                                            },
                                        ].map((x, i) => (
                                            <li key={i} className="flex items-start gap-2">
                                                <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                                                <span>
                                                    <strong className="text-foreground">{x.title}:</strong>{' '}
                                                    {x.body}
                                                </span>
                                            </li>
                                        ))}
                                        ...
                                        {[
                                            {
                                                ...
                                                body: 'We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.',
                                            },
                                            {
                                                title: 'For business transfers',
                                                body: 'We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.',
                                            },
                                            {
                                                title: 'With Affiliates',
                                                body: 'We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.',
                                            },
                                            {
                                            ...
                                            },
                                            {
                                                ...
                                                body: "when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.",
                                            },
                                            {
                                                title: 'With Your consent',
                                                body: 'We may disclose Your personal information for any other purpose with Your consent.',
                                            },
                                        ].map((x, i) => (
                                            <li key={i} className="flex items-start gap-2">
                                                <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2" />
                ...
                {/* Contact Card */}
                <div className="rounded-xl border border-primary/20 bg-primary/5 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                    ...
                    <a
                        href="mailto:daveycodez@gmail.com"
