...
function AboutPage() {
	return (
		<div>
			...
			<section className="pt-[180px] pb-[70px] relative">
				<div className="container mx-auto px-4 max-w-[1140px]">
					<div className="max-w-3xl">
						<p className="text-sm font-bold text-wild-blue-yonder mb-5">About Us</p>
						<h1 className="headline headline-1 mb-5">
							Building the Future of{" "}
							<span className="navy-blue-blog-gradient-text">Content Management</span>
						</h1>
						<p className="text-lg text-wild-blue-yonder leading-relaxed">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
						{stats.map((stat) => (
							...
							>
								...
								<p className="text-wild-blue-yonder">{stat.label}</p>
							</div>
						))}
					</div>
				</div>
			...
			<section className="navy-blue-blog-section">
				<div className="container mx-auto px-4 max-w-[1140px]">
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div>
							<h2 className="headline headline-2 text-columbia-blue mb-6">
								Our <span className="navy-blue-blog-gradient-text">Story</span>
							</h2>
							<div className="space-y-4 text-wild-blue-yonder">
								<p>
						...
						<div className="relative">
							...
							<div className="absolute -bottom-6 -left-6 navy-blue-blog-card p-6 rounded-2xl">
								...
								<p className="text-sm text-wild-blue-yonder">Founded</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section className="navy-blue-blog-section">
				<div className="container mx-auto px-4 max-w-[1140px]">
					<h2 className="headline headline-2 text-columbia-blue mb-2.5 text-center">
						Why Choose <span className="navy-blue-blog-gradient-text">BlogCMS</span>
					</h2>
					<p className="text-lg text-wild-blue-yonder mb-16 text-center max-w-2xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="navy-blue-blog-card p-8 rounded-2xl text-center transition-all hover:-translate-y-1">
							...
							<h3 className="text-xl font-bold text-columbia-blue mb-4">Lightning Fast</h3>
						...
						<div className="navy-blue-blog-card p-8 rounded-2xl text-center transition-all hover:-translate-y-1">
							...
							<h3 className="text-xl font-bold text-columbia-blue mb-4">Git-Backed</h3>
							<p className="text-wild-blue-yonder">
						...
						<div className="navy-blue-blog-card p-8 rounded-2xl text-center transition-all hover:-translate-y-1">
							...
							<h3 className="text-xl font-bold text-columbia-blue mb-4">Live Preview</h3>
							<p className="text-wild-blue-yonder">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{team.map((member) => (
							<div
								...
								className="navy-blue-blog-card p-8 rounded-2xl text-center transition-all hover:-translate-y-1"
							>
								<Avatar className="w-24 h-24 mx-auto mb-6 border-4 border-carolina-blue">
									<AvatarImage src={member.avatar} alt={`${member.name}'s profile photo`} />
									<AvatarFallback className="bg-prussian-blue text-2xl">
										{member.name.charAt(0)}
									</AvatarFallback>
								</Avatar>
								<h3 className="text-xl font-bold text-columbia-blue mb-1">{member.name}</h3>
								<p className="text-sm text-carolina-blue mb-4">{member.role}</p>
								<p className="text-wild-blue-yonder text-sm mb-6">{member.bio}</p>
				...
				<div className="container mx-auto px-4 max-w-[1140px]">
					<div className="navy-blue-blog-card p-12 rounded-3xl text-center relative overflow-hidden">
						<div className="relative z-10">
							<h2 className="headline headline-2 text-columbia-blue mb-4">
								Ready to Get Started?
							</h2>
							<p className="text-lg text-wild-blue-yonder mb-8 max-w-xl mx-auto">
							...
							<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
								...
								<a
									...
									className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-prussian-blue text-columbia-blue hover:border-carolina-blue transition-colors"
								>
